...
<img src="./public/fig3.png" width="600" />
...
<img src="./public/fig4.png" class="w-96 mx-auto" />
...
<img src="./public/fig5.png" class="w-96 mx-auto" />
...
この論文の主張は，隕石・惑星材料は，炭素質 carbonaceous と非炭素質 noncarbonaceous の二つに大きく分かれるというものです．その根拠は，チタン，クロム，酸素，ニッケルの安定同位体組成です．特に ε54Cr–ε50Ti 図や ε54Cr–Δ17O 図では，炭素質コンドライトが他の隕石・惑星材料から明確に離れた領域に分布します．この二峰性は，従来の隕石分類よりも，炭素質／非炭素質という分類が根本的である可能性を示します．
...
<img src="./public/fig6.jpeg" class="w-160 mx-auto" />
...
横軸は軌道長半径，縦軸は離心率を表す．これは，小惑星のような軌道を持ちながら，
質量放出によって彗星のような外観を示す天体である．

縦の破線は，火星と木星の軌道，および木星との 2:1 平均運動共鳴の位置を示す．
斜めの曲線は，遠日点が木星の近日点距離に等しい点，および近日点が火星の遠日点距離に等しい点の軌跡を示す．
...
一部の活動的小惑星は，小惑星同士の衝突によって生じる．小惑星帯では典型的な衝突速度が$\Delta V \sim 5\,\mathrm{km\,s^{-1}}$ と大きく，これは公転速度 $V_K \sim 20\,\mathrm{km\,s^{-1}}$のかなりの割合に相当する．軌道傾斜角$i \sim 15$，離心率$e \sim 0.15$の軌道で高速衝突になり，
- 蒸発：$V > (2H)^{1/2}$で発生する．$H = 2 \times 10^6\,\mathrm{J\,kg^{-1}}$潜熱であり，代入すると$V > 2$\,km\,s$^{-1}$となる．
...
熱膨張率 $\alpha \sim 10^{-5}\, \mathrm{K^{-1}}$とし，温度変化による長さの変化$\alpha \Delta T$である．

岩石の応力は，$S \sim Y\alpha \Delta T$ であり，$Y$をヤング率と呼ぶ．$Y \sim 10^{10} - 10^{11}\, \mathrm{N\, m^{-2}} \quad \rightarrow \, S \sim 10^5 - 10^6\Delta T$．玄武岩の引張強度は $\sim 4 \times 10^6\,\mathrm{N\, m^{-2}}$である．

温度が繰り返して変化し，熱拡散率 $\kappa$ と自転周期との関係は $l \sim \left( \kappa P \right)^{1/2}$，$\kappa \sim 10^{-6}\,\mathrm{m^2\,s^{-1}}$，$P= 5\,\mathrm{h}$を代入し，$l = \sqrt{1-^{-6} \cdot 5 \cdot 3600} \sim 0.13\,\mathrm{m} \sim 15\,\mathrm{cm}$ となる．

ふたご座流星群である母天体（3200）Phaethonの近日点 $q=0.14\,\mathrm{AU}$ であり，温度差 $\Delta T \sim 600\,\mathrm{K}$ と考えられている．3.5時間の自転周期に加えて，近日点付近で彗星のように塵を放出し，尾が見える．
...
<img src="./public/fig7.png" class="w-120 mx-auto" />
